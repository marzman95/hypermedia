...
<html lang="en">
<head>
  <title>Binding Study Recommendation</title>
  <meta charset="utf-8">
...
<body onLoad="checkSize()">
  ...
  <div id="slidermenu" >
    ...
    <div id="hidable">
      <a href="bsr.php"><button type="button" class="menubtn tuefont">Binding Study Recommendation</button></a>
    ...
    <div class="row">
      <div class="col-sm-3" id="more">
        <div class="center-block tuefont sidemenu" id="fixedmenu">
          <a href="bsr.php" role="button" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>Binding Study Recommendation</span></a>
