...
<div id="slidermenu" >
    ...
    <div id="hidable">
    <a href="master_prof_skills.php"><button type="button" class="menubtn tuefont">Professional skills</button></a>
		<a href="exchange.php"><button type="button" class="menubtn tuefont">Exchange options</button></a>
    <a href="master_coaching.php"><button type="button" class="menubtn tuefont">Coaching</button></a>
		<a href="masterhonors.php"><button type="button" class="menubtn tuefont">Master's honors</button></a>
    ...
    <a href="master_regulations.php"><button type="button" class="menubtn tuefont">Regulations</button></a>
    </div>
</div>
