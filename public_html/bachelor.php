...
<body onLoad="checkSize()">
  ...
  <div class="jumbotron">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-9">
          <img src="Images/headercw.png" class="img-responsive" style="padding-left: 60px; width:80%;" alt="Image">
        </div>
        <div class="col-sm-3">
  ...
  <div id="slidermenu" >
    ...
    <div id="hidable">
      <a href="bachelor/prof_skills.php"><button type="button" class="menubtn tuefont">Professional skills</button></a>
      <a href="bachelor/use.php"><button type="button" class="menubtn tuefont">USE</button></a>
      <a href="bachelor/coaching.php"><button type="button" class="menubtn tuefont">Coaching</button></a>
      <a href="bachelor/honors.php"><button type="button" class="menubtn tuefont">Bachelor honors</button></a>
      ...
      <a href="bachelor/regulations.php"><button type="button" class="menubtn tuefont">Regulations</button></a>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-sm-3" id="more">
        <div class="center-block tuefont sidemenu" id="fixedmenu">
          <a href="bachelor/prof_skills.php" role="button" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>Professional skills</span></a>
          <a href="bachelor/use.php" role="button" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>USE</span></a>
          <a href="bachelor/coaching.php" role="button" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>Coaching</span></a>
          <a href="bachelor/honors.php" role="button" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>Bachelor Honors</span></a>
          ...
          <a href="bachelor/regulations.php" role="button" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>Regulations</span></a>
        </div>
      </div>
      ...
      <div class="col-sm-9 tuefont" id="fixedcontent">
        ...
        <div class="row">
          <div class="col-md-2">
            <a href="bachelor/cs.php"><div class="bachelor-block center-block"><span class="fa fa-laptop fa-2x"></span><br>Computer Science &amp; Engineering</div></a>
          </div>
          <div class="col-md-2">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <a href="bachelor/pt.php"><div class="bachelor-block center-block"><span class="fa fa-users fa-2x"></span><br>Psychology &amp; Technology</div></a>
          </div>
          <div class="col-md-2">
