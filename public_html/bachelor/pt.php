...
<html lang="en">
<head>
  <title>Psychology and Technology</title>
  <meta charset="utf-8">
...
<body onLoad="checkSize()">
  ...
  <div id="slidermenu" >
    ...
    <div id="hidable">
      ...
      <button type="button" onClick="document.getElementById('project').scrollIntoView();" class="menubtn tuefont">Final project</button>
      <button type="button" onClick="document.getElementById('asmasters').scrollIntoView();" class="menubtn tuefont">Associated Masters</button>
    ...
    <div class="row">
      ...
      <div class="col-sm-3"  id="more">
        <div class="center-block tuefont sidemenu" id="fixedmenu">
          ...
          <button type="button" onClick="document.getElementById('project').scrollIntoView();" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>Final Project</span></button>
          <button type="button" onClick="document.getElementById('asmasters').scrollIntoView();" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>Associated Masters</span></button>
