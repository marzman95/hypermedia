...
<html lang="en">
<head>
  <title>Human-Technology Interaction</title>
  <meta charset="utf-8">
...
<body onLoad="checkSize()">
  ...
  <div id="slidermenu" >
    ...
    <div id="hidable">
      ...
      <button type="button" onClick="document.getElementById('aspostmasters').scrollIntoView();" class="menubtn tuefont">Associated Masters</button>
