...
<html lang="en">
<head>
  <title>Post-master programs</title>
  <meta charset="utf-8">
...
<div id="hidable">
<button type="button" onClick="document.getElementById('phd').scrollIntoView();" class="menubtn tuefont">PHD</button>
<button type="button" onClick="document.getElementById('pdeng').scrollIntoView();" class="menubtn tuefont">PDEng</button>
...
<div class="center-block tuefont sidemenu" id="fixedmenu">
    ...
    <div class="col-sm-12 tuefont" id="fixedcontent">
