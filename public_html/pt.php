...
<div class="center-block tuefont sidemenu" id="fixedmenu">
    ...
    <button type="button" onClick="document.getElementById('project').scrollIntoView();" class="btn btn-default btn-lg btn-block" style="vertical-align:middle"><span>Final Project</span></button>
    <button type="button" onClick="document.getElementById('asmasters').scrollIntoView();" class="btn btn-default btn-lg btn-block" style="vertical-align:middle"><span>Associated Masters</span></button>
