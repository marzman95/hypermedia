...
<body onLoad="checkSize()">
  ...
  <div id="slidermenu" >
    ...
    <div id="hidable">
      <a href="premaster/bsr.php"><button type="button" class="menubtn tuefont">Binding Study Recommendation</button></a>
      <a href="premaster/regulations.php"><button type="button" class="menubtn tuefont">Regulations</button></a>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-9 tuefont" id="fixedcontent">
        ...
        <div class="row">
          <div class="col-md-2">
            <a href="premaster/cs.php"><div class="bachelor-block center-block"><span class="fa fa-laptop fa-2x"></span><br>Computer Science &amp; Engineering</div></a>
          </div>
          <div class="col-md-2">
