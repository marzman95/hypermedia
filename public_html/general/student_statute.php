...
<body onLoad="checkSize()">
  ...
  <div id="slidermenu" >
      ...
      <a href="studentsstatute.php"><button type="button" class="menubtn tuefont">Students Statute</button></a>
    ...
    <div class="row">
      <div class="col-sm-3" id="more">
        <div class="center-block tuefont sidemenu" id="fixedmenu">
          ...
          <a href="studentsstatute.php" role="button" class="btn btn-default btn-lg btn-block font-smaller" style="vertical-align:middle"><span>Students Statute</span></a>
