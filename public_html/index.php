    ...
    <nav class="navbar navbar-default text-black" id="footermenu">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav tuefont">
          ...
          <li><a href="general/student_statute.php">Students Statute</a></li>
    ...
    <div id="footerlinks">
      <div class="tuefont">
        ...
        <div class="btn-group btn-group-justified" role="group" aria-label="...">
          ...
          <div class="btn-group" role="group">
            <button type="button" onclick="location.href='general/student_statute.php';" class="btn btn-default"><span>Students Statute</span></button>
          </div>
          <div class="btn-group" role="group">
